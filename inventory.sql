...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Nov 2024 pada 07.02
...
--
-- Struktur dari tabel `borrow_item`
--
...
('xQERJuM8KH4mDMdgmJhhEdsNKisiZFbyIMTzGCQK', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', '', 1731564136);
...
--
-- Indeks untuk tabel `borrow_item`
--
...
--
-- AUTO_INCREMENT untuk tabel `borrow_item`
--
ALTER TABLE `borrow_item`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Ketidakleluasaan untuk tabel `borrow_item`
--
ALTER TABLE `borrow_item`
