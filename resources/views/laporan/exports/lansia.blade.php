...
<body>
    ...
    <table border="1" style="border-collapse: collapse;">
        ...
        {{-- ================= JUDUL LAPORAN ================= --}}
        <tr>
            <td colspan="20" style="text-align: center; font-size: 13pt; font-weight: bold; text-decoration: underline; border:none; height: 30px; vertical-align: middle;">
        ...
        <tr>
            <td colspan="20" style="text-align: center; font-size: 11pt; font-style: italic; border:none;">
