            ...
            <div class="content">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Laporan Data Hipertensi</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('laporan.hipertensi') }}" method="GET" class="mb-4">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route('laporan.hipertensi') }}" class="btn btn-warning btn-round mr-2">Reset</a>
                                    <a href="{{ route('laporan.export.pdf', ['jenis' => 'hipertensi'] + request()->all()) }}" class="btn btn-danger btn-round" target="_blank">PDF</a>
                                    <a href="{{ route('laporan.export.excel', ['jenis' => 'hipertensi'] + request()->all()) }}" class="btn btn-success btn-round" target="_blank">Excel</a>
                                </div>
                            </div>
                        </form>
